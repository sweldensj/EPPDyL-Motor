...
#----------------------------------------------------------------
    #Establishing global variables and settings.
#----------------------------------------------------------------
...
motorMaxSpeed = 200 #STEPS PER SECOND, Default value is 200 steps per second. Not recommened to exceed this
...
# -----------------------------------------------------------------------------
    ...
    def motor_calibrate(self):
        ...
        while continueLoop:
            ...
            continueLoop = (time.time() - startTime <= 60) and not limitReached
